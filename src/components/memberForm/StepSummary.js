    ...
    <Box>
      ...
      <Grid container spacing={2}>
        ...
        <Grid item xs={12} sm={6}>
          ...
          <Typography component="div"><strong>Baptized in Christ Embassy:</strong> {values.baptized_in_christ_embassy === 'true' ? 'Yes' : values.baptized_in_christ_embassy === 'false' ? 'No' : '-'}</Typography>
