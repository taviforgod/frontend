...
import { Grid, TextField, Autocomplete, Button, Box, Avatar } from '@mui/material';
      ...
      <Grid item xs={12} sm={6}>
        ...
        <label htmlFor="profile-photo-upload">
          <Button variant="outlined" component="span" fullWidth>
            {formValues.profile_photo ? 'Change Photo' : 'Upload Photo'}
          </Button>
        </label>
        {formValues.profile_photo ? (
          <Box mt={1}>
            <img
              src={typeof formValues.profile_photo === 'string'
                ? formValues.profile_photo
                : URL.createObjectURL(formValues.profile_photo)}
              alt="Profile Preview"
