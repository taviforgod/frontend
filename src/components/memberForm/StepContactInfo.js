    ...
    <Grid container spacing={2}>
      <Grid item xs={12} sm={6}>
        <TextField
          ...
          helperText={<span>{validationErrors.email || 'e.g. user@example.com'}</span>}
          required
          fullWidth
      ...
      <Grid item xs={12} sm={6}>
        <TextField
          ...
          helperText={<span>{validationErrors.contact_primary || 'e.g. +1234567890'}</span>}
          required
          fullWidth
          InputProps={{
      ...
      <Grid item xs={12} sm={6}>
        <TextField
          ...
          helperText={<span>{validationErrors.contact_secondary || 'Optional'}</span>}
          fullWidth
          InputProps={{
